...
!function() {
  ...
  Promise.prototype.promise = function() {
    ...
    for(index = 0; curr = PROMISE_METHODS[index]; index++) {
      wrapper[curr] = bind(this[curr], this);
    }
  ...
  function isThenable(obj) {
    var thenable = true;
    for(var curr, index = 0; curr = PROMISE_METHODS[index]; index++) {
      thenable = thenable && obj[curr] && typeof obj[curr] === 'function';
    }
    return thenable;
  }
